        ...
        <div class="relative flex-1 flex items-center justify-center bg-white lg:bg-transparent z-10">
            ...
            <div class="relative w-full max-w-lg p-8 bg-white/90 lg:bg-white rounded-lg shadow-lg lg:shadow-none">
                ...
                <div class="text-center mb-6">
                    ...
                    <p class="text-sm text-gray-500">Sign in dan lanjutin kerjaanmu !</p>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="email" value="{{ old('email') }}"
                            class="input-c mt-1 w-full border-b-2 border-gray-300 focus:border-yellow-400 focus:ring-0 px-0 py-2 text-gray-900 placeholder-gray-400 sm:text-sm"
