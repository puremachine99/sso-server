                ...
                <div style="--col-span-default: span 1 / span 1;" class="col-[--col-span-default]">
                    <div data-field-wrapper="" class="fi-fo-field-wrp">
                        <div class="grid gap-y-2">
                            ...
                            <div class="fi-input-wrp flex rounded-lg shadow-sm ring-1 transition duration-75 bg-white dark:bg-white/5 ring-gray-950/10 dark:ring-white/20 overflow-hidden">
                                <span class="fi-input block w-full border-none py-1.5 text-base text-gray-950 dark:text-white sm:text-sm sm:leading-6 bg-white/0 ps-3 pe-3">
                                    {{ auth()->user()->name }}
                                </span>
                            </div>
                        </div>
