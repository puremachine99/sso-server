        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden mb-8">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-indigo-700 p-6 text-white">
                <div class="flex flex-col md:flex-row items-start md:items-center gap-6">
                    <div
                        class="w-24 h-24 bg-white rounded-full flex items-center justify-center text-blue-800 text-4xl font-bold shadow-md">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="mt-3 flex flex-wrap gap-2">
                            ...
                            <span class="bg-blue-500/30 px-3 py-1 rounded-full text-sm">
                                ...
                                {{ $user->jobDetail->employee_status ?? 'Status Tidak Tersedia' }}
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="border-b border-gray-200">
                <nav class="flex overflow-x-auto">
                    <button
                        class="tab-btn active px-6 py-4 font-medium text-sm border-b-2 border-blue-600 text-blue-600"
                        data-tab="personal">
                        <i class="fas fa-user mr-2"></i> Personal
                    </button>
                    <button class="tab-btn px-6 py-4 font-medium text-sm text-gray-500 hover:text-blue-600"
                        data-tab="employment">
                            ...
                            @if ($user->smartnakamaProfile)
                                <div class="space-y-3">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <span class="font-medium">{{ $user->smartnakamaProfile->birth_place ?? '-' }},
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <span
                                            class="font-medium">{{ $user->smartnakamaProfile->marital_status ?? '-' }}</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-gray-600">Agama</span>
                                        <span
                                            class="font-medium">{{ $user->smartnakamaProfile->religion ?? '-' }}</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-gray-600">Golongan Darah</span>
                                        <span
                                            class="font-medium">{{ $user->smartnakamaProfile->blood_type ?? '-' }}</span>
                                    </div>
                                </div>
                            @else
                            ...
                            @if ($user->jobDetail)
                                <div class="space-y-3">
                                    <div class="flex justify-between">
                                        ...
                                        <span class="font-medium">{{ $user->jobDetail->position ?? 'N/A' }}</span>
                                    </div>
                                    <div class="flex justify-between">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <span
                                            class="font-medium">{{ $user->jobDetail->employee_status ?? 'N/A' }}</span>
                                    </div>
                                </div>
                            @else
                            ...
                            @forelse($user->salaryDetails as $salary)
                                <div class="space-y-3">
                                    <div class="flex justify-between">
                                        ...
                                        <span
                                            class="font-medium">Rp{{ number_format($salary->base_salary, 0, ',', '.') }}</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-gray-600">Bonus</span>
                                        <span
                                            class="font-medium">Rp{{ number_format($salary->bonus, 0, ',', '.') }}</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-gray-600">Potongan</span>
                                        <span
                                            class="font-medium">Rp{{ number_format($salary->deduction, 0, ',', '.') }}</span>
                                    </div>
                                    <div class="flex justify-between">
                        ...
                        <div class="bg-gray-50 p-5 rounded-lg border border-gray-200">
                            ...
                            @forelse($user->educationBackgrounds as $edu)
                                <div class="mb-4 pb-4 border-b border-gray-200 last:border-0 last:pb-0 last:mb-0">
                                    <h4 class="font-semibold text-gray-800">{{ $edu->degree }} -
                                        {{ $edu->field_of_study }}</h4>
                            ...
                            @forelse($user->competencySpecifications as $skill)
                                <div class="mb-4">
                                    <div class="flex justify-between mb-1">
                                        <span
                                            class="font-medium text-gray-700 capitalize">{{ $skill->competency }}</span>
